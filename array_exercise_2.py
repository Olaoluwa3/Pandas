...
print(f"Min Sale: {minSale}, Max Sale: {maxSale}")

## Step 3: Print an array that will show which sales are greater than or equal to $100.
print("-----------------------------------------------   STEP THREE  -----------------------------------------------")
salesGreaterThanOrEqual100 = salesArray[salesArray>=100]
print(salesGreaterThanOrEqual100)

## Step 4: Print the total sales for each register.
print("-----------------------------------------------   STEP FOUR   -----------------------------------------------")
totSalesbyRow = salesArray.sum(axis=1)
print(totSalesbyRow)
...
print("-----------------------------------------------   STEP FIVE  -----------------------------------------------")
salesFee = salesArray*0.02
#salesFeebyRegister = salesFee.T  #to get by register on each column
totFee = salesFee.sum()
print(f"Sales Fee Array: {salesFee}, \nTotal Fee: {totFee}")
